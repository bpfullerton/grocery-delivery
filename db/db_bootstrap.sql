...
insert into Customer (customerId, firstName, lastName, email, addressNum, street, city, addressState, zip, bankAcctNum, paymentApp, creditCard, employeeRepId) 
    values ('42447219', 'Marena', 'Hebdon', 'mhebdon1@google.co.uk', '94134', 'Bunker Hill', 'Lipník nad Bečvou', null, '75701', '9070896625', null, '3544477625962458', '85107380');
insert into Customer (customerId, firstName, lastName, email, addressNum, street, city, addressState, zip, bankAcctNum, paymentApp, creditCard, employeeRepId) 
    values ('60542269', 'Serena', 'Hackett', 'shackett2@woothemes.com', '12204', 'Hollow Ridge', 'São Lourenço da Mata', null, '54700', '7987617660', '@SerenaHackett', null, '31141736');
insert into Customer (customerId, firstName, lastName, email, addressNum, street, city, addressState, zip, bankAcctNum, paymentApp, creditCard, employeeRepId) 
